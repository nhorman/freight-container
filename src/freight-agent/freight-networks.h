...
extern int get_address_for_interfaces(const struct ifc_list *list, const char *container, const struct agent_config *acfg);
extern void release_address_for_interfaces(const struct ifc_list *list, const struct agent_config *acfg);
